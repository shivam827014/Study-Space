      ...
      <div className="py-8 container mx-auto">
        <div className="container mx-auto px-4 text-center max-w-screen-lg">
          <p className="text-lg mb-4">
            StudySpace is a platform designed to enhance collaboration and knowledge sharing among
          ...
          <p className="text-lg">Join StudySpace today and revolutionize the way you study!</p>
